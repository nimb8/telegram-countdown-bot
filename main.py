...
VACATION_DATE = datetime(2025, 7, 27, 14, 52, 0, tzinfo=timezone.utc)  # дата и время отпуска (UTC)
...
async def send_countdown():
    ...
    while True:
        ...
        target_time_today = datetime.combine(now.date(), time(14, 52, 0, tzinfo=timezone.utc))
