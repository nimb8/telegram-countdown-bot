...
print("Текущее время UTC:", now.isoformat())

BOT_TOKEN = "7857747352:AAGL6XXQyZlj-6k_U6BV-rFF2wacDRdGjVE"  # или os.getenv("BOT_TOKEN")
CHAT_ID = "-4874063053"        # или os.getenv("CHAT_ID")

VACATION_DATE = datetime(2025, 7, 27, 12, 14, 0, tzinfo=timezone.utc)  # дата и время отпуска (UTC)
...
async def send_countdown():
    ...
    while True:
        ...
        target_time_today = datetime.combine(now.date(), time(12, 15, 0, tzinfo=timezone.utc))
